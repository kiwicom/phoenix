...
def test_not_resolved_on_time():
    ...
    assert o.resolved_on_time is False, "Not resolved after deadline should " "be False"
...
def test_resolved_on_time():
    ...
    o.eta = -10
    assert o.resolved_on_time is False, "Resolved after deadline should be " "False"
    o.eta = 10
