...
SLACK_NOTIFY_B2B_CHANNEL_ID = os.getenv("SLACK_NOTIFY_B2B_CHANNEL_ID")
...
GITLAB_POSTMORTEM_DAYS_TO_NOTIFY = list(
    map(int, os.getenv("GITLAB_POSTMORTEM_DAYS_TO_NOTIFY", "3,7").split(","))
)
...
POSTMORTEM_NOTIFICATION_LIST_LIMIT = int(
    os.getenv("POSTMORTEM_NOTIFICATION_LIST_LIMIT", "60")
)
POSTMORTEM_SLACK_NOTIFICATION_LIMIT = int(
    os.getenv("POSTMORTEM_SLACK_NOTIFICATION_LIMIT", "12")
)
POSTMORTEM_EMAIL_NOTIFICATION_LIMIT = int(
    os.getenv("POSTMORTEM_EMAIL_NOTIFICATION_LIMIT", "24")
)
POSTMORTEM_LABEL_NOTIFICATION_LIMIT = int(
    os.getenv("POSTMORTEM_LABEL_NOTIFICATION_LIMIT", "48")
)
